  ...
  const differentiators = [
    {
      ...
      description: "20+ pages of deep research per battlecard, including full review data mining, customer quotes, competitive positioning, SWOT analysis, tactical discovery questions, and objection handling. We also load your product as 'us' to give honest win/loss comparisons showing where you beat competitors and where you don't. Our AI synthesizes all this context into instant Slack answers.",
